...
- 정답 판별2 : 스크라이크와 볼은 각각 CallStrike, CallBall 의 메서드에서 판별하며 두 클래스는 추상클래스 abstract Call 을 참조했습니다.
              두개의 메서드는 숫자를 반환하며 반환된 숫자를 BSCall 에 넣으면 스트라이크와 볼을, 혹은 맞는 숫자가 없을시 Nothing 을 반환합니다.
